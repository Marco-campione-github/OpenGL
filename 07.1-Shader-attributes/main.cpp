/**
    ...
    Gli attributi sono memorizzati in un array di float in modo intercalato.
*/
...
void create_scene() {
    ...
    // Usiamo un solo array di vec3 e le informazioni sono intercalate:
    // coordinate1, colore1, coordinate2, colore2, coordinate3, colore3
    ...
    // Rispetto l'inizio dell'array, la prima tripletta RGB si trova ad un offset di sizeof(glm::vec3) bytes.
    // L'offset và dato come puntatore (a void) ed è per questo che è necessario eseguire il cast. 
    // 0 è equivalente al puntatore null.
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 2*sizeof(glm::vec3), reinterpret_cast<GLvoid*>(sizeof(glm::vec3)));
