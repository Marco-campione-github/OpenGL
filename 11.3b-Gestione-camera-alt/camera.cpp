...
bool Camera::onMouse(int x, int y) {
  ...
  glm::mat4 Ry = glm::rotate(glm::mat4(1.0),glm::radians(-xoffset),glm::vec3(0,1,0));
  glm::mat4 Rx = glm::rotate(glm::mat4(1.0),glm::radians(yoffset),glm::vec3(1,0,0));

  _lookat_dir = glm::vec3(Rx*Ry*glm::vec4(_lookat_dir,0));
